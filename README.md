...
### 3. RDS Database
![RDS Database](./RDS%20Databases.png)

### 4. Database Created for Backend Server
![Database Created](./Databases%20created%20Backend%20server.png)

### 5. Backend Command Execution
![Backend Command](./Command%20for%20Backend.png)

### 6. Backend Server Open in Browser
![Backend Server](./Backend%20server%20(open%20in%20browser).png)
...
![Frontend Server](./Frontend%20server%20(browser).png)

### 10. Frontend Calling Backend
![Frontend Calling Backend](./frontend%20server%20calling%20to%20Backend.png)
